...
public class MaterialPage {
	...
	public String getRequestIdOne() throws InterruptedException, FileNotFoundException, IOException {
		 ...
		 * 60); wait.until(ExpectedConditions.visibilityOfElementLocated(
		 ...
		 * .withTimeout(Duration.ofSeconds(400)) .pollingEvery(Duration.ofMillis(600))
		 * .ignoring(NoSuchElementException.class);
		 * 
		 * WebElement msgRequestSuccess=wait.until(new Function<WebDriver, WebElement>()
		 * { public WebElement apply(WebDriver driver) { return
		 * driver.findElement(By.xpath(
		 * ".//*[@id='mxui_widget_DialogMessage_0']/div[1]/div[2]/p")); } });
		 */
	...
	/*
	 * public String getRequestId_Create() throws InterruptedException,
	 * FileNotFoundException, IOException {
	 * 
	 * Sync.waitForSeconds(Constants.WAIT_6); Sync.waitForObject(driver,
	 * "Wait of Dialog Box Success Message", msgRequestSuccess); String
	 * reqId=driver.findElement(By.xpath(
	 * ".//*[@id='mxui_widget_DialogMessage_0']/div[1]/div[2]/p")).getText();
	 * String[] parts = reqId.split(" "); String Id = parts[2]; String IdNum =
	 * Id.replaceAll("\\.", ""); System.out.println("RequestId is: " + Id);
	 * ExcelUtil.excelWrite(IdNum); System.out.println("RequestId is: " + IdNum);
	 * Sync.waitForSeconds(Constants.WAIT_3);
	 * Sync.waitForElementToBeClickable(driver, btnMsgReqIdOkdraft); //
	 * Button.click("Click Ok Button", btnMsgReqIdOkdraft); return Id; }
	 */
	 ...
	 * Button.click("Click Materials Menu", textMaterial); return
	 * Button.click("Click Dashboard Menu", menuMaterialDashboard); }
	 */
	...
	public String getRequestId_Create() throws InterruptedException, FileNotFoundException, IOException {
